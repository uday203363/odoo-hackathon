...
export const INITIAL_USERS: User[] = [
  {
    ...
    address: 'Global Headquarters, San Francisco, CA',
    joinDate: '2019-01-01',
    ...
    skills: ['System Architecture', 'Global HR', 'Security', 'Compliance'],
  ...
  },
  {
    ...
    employmentStatus: 'Active',
    skills: ['HRMS', 'Recruiting', 'Compliance', 'Policy Design'],
  ...
  },
  {
    ...
    skills: ['Excel', 'Power BI', 'SQL', 'Financial Modeling'],
  ...
  },
  {
    ...
    address: '1200 Howard St, San Francisco, CA',
    joinDate: '2022-04-20',
    ...
    employmentStatus: 'Active',
    skills: ['SEO', 'Content Strategy', 'HubSpot', 'Google Ads'],
  ...
  },
  {
    id: 'usr-emp-5',
    employeeId: 'EMP-106',
    name: 'R.Uday kumar reddy',
    email: 'uday@dayflow.com',
    password: 'join@123',
    role: 'employee',
...
export const INITIAL_LEAVE_REQUESTS: LeaveRequest[] = [
  { id: 'lv-001', employeeId: 'EMP-102', employeeName: 'Alex Morgan', employeeAvatar: INITIAL_USERS[2].avatar, employeeDepartment: 'Engineering', leaveType: 'Paid', startDate: '2026-08-28', endDate: '2026-08-30', daysCount: 3, reason: 'Tech Summit in Austin.', status: 'Pending', appliedOn: '2026-08-20' },
  { id: 'lv-002', employeeId: 'EMP-103', employeeName: 'Sarah Jenkins', employeeAvatar: INITIAL_USERS[3].avatar, employeeDepartment: 'Design', leaveType: 'Paid', startDate: '2026-08-22', endDate: '2026-08-24', daysCount: 3, reason: 'Family vacation.', status: 'Approved', appliedOn: '2026-08-15', adminComments: 'Approved! Have a great trip.', reviewedBy: 'Elena Rostova', reviewedOn: '2026-08-16' },
  { id: 'lv-003', employeeId: 'EMP-104', employeeName: 'David Chen', employeeAvatar: INITIAL_USERS[4].avatar, employeeDepartment: 'Finance', leaveType: 'Sick', startDate: '2026-08-10', endDate: '2026-08-11', daysCount: 2, reason: 'Flu and medical rest.', status: 'Approved', appliedOn: '2026-08-10', adminComments: 'Get well soon!', reviewedBy: 'Elena Rostova', reviewedOn: '2026-08-10' },
  { id: 'lv-004', employeeId: 'EMP-104', employeeName: 'David Chen', employeeAvatar: INITIAL_USERS[4].avatar, employeeDepartment: 'Finance', leaveType: 'Casual', startDate: '2026-09-05', endDate: '2026-09-08', daysCount: 4, reason: 'Apartment relocation.', status: 'Pending', appliedOn: '2026-08-21' },
];

export const INITIAL_WFH_REQUESTS: WFHRequest[] = [
  { id: 'wfh-001', employeeId: 'EMP-102', employeeName: 'Alex Morgan', employeeAvatar: INITIAL_USERS[2].avatar, department: 'Engineering', date: TODAY, reason: 'Internet upgrade at office building.', status: 'Approved', appliedOn: '2026-08-21', reviewedBy: 'Elena Rostova' },
  { id: 'wfh-002', employeeId: 'EMP-105', employeeName: 'Priya Patel', employeeAvatar: INITIAL_USERS[5].avatar, department: 'Marketing', date: '2026-08-25', reason: 'Personal errand in morning.', status: 'Pending', appliedOn: '2026-08-22' },
];
...
export const INITIAL_PAYROLL: PayrollRecord[] = INITIAL_USERS.map((u, i) => {
  ...
  return {
    ...
    totalDeductions,
    netPay: u.salary.netSalary,
    paymentStatus: 'Paid',
    paymentDate: '2026-08-01',
    workingDays: 26,
    presentDays: [25, 24, 22, 23, 20, 24, 25, 25, 25][i] || 24,
  };
});
...
export const INITIAL_NOTIFICATIONS: NotificationItem[] = [
  { id: 'notif-1', title: 'Leave Approved', message: 'Your leave request for Aug 22–24 has been approved by HR.', timestamp: '10 mins ago', read: false, type: 'success' },
  { id: 'notif-2', title: 'New Announcement', message: 'Office Wi-Fi Maintenance scheduled for Aug 24.', timestamp: '1 hour ago', read: false, type: 'info' },
  { id: 'notif-3', title: 'Payslip Released', message: 'August 2026 payslip is available to view/download.', timestamp: '1 day ago', read: true, type: 'info' },
];
